package com.vaniala.notesprovider.database
...
import com.vaniala.notesprovider.database.NotesDataBaseHelper.Companion.TABLE_NOTES

class NotestProvider : ContentProvider() {
    ...
    companion object {
        private const val AUTHORITY = "com.vania.notesprovider.provider"
