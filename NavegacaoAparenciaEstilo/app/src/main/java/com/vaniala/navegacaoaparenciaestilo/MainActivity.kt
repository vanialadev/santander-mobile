...
import com.vaniala.navegacaoaparenciaestilo.DetailActivity.Companion.EXTRA_CONTACT
...
class MainActivity : AppCompatActivity(), ClickItemContactListener {
    ...
    private fun getInstanceSharedPreferences(): SharedPreferences {
        return getSharedPreferences("com.vaniala.navegcao", Context.MODE_PRIVATE)
    }
